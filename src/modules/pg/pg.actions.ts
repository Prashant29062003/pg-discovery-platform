...
export async function createPGInternal(data: CreatePGInput) {
  ...
  const result = await db
    ...
    .values({
      ...
      thumbnailImage: validated.thumbnailImage ?? undefined,
      ...
      checkInTime: validated.checkInTime ?? undefined,
      checkOutTime: validated.checkOutTime ?? undefined,
      minStayDays: validated.minStayDays ?? 1,
      cancellationPolicy: validated.cancellationPolicy ?? undefined,
      rulesAndRegulations: validated.rulesAndRegulations ?? undefined,
