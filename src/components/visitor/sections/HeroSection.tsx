      ...
      <div className="container mx-auto px-6 lg:px-14 py-10 lg:py-20 lg:grid lg:lg:grid-cols-2 flex flex-col-reverse gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-foreground leading-[0.9]">
            Elevate Your <br />
            <span className="text-orange-600 dark:text-orange-500">Living Standard.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-4">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="rounded-full px-8 h-12 lg:h-14 text-base border-border hover:bg-accent transition-all active:scale-95"
            >
          ...
          {/* Social Proof Stats */}
          <div className="flex items-center justify-center lg:justify-start gap-6 lg:gap-8 pt-8 border-t border-border">
            <div>
              <p className="text-xl lg:text-2xl font-bold text-foreground">500+</p>
              <p className="text-[10px] lg:text-xs text-muted-foreground uppercase tracking-widest font-bold">Happy Residents</p>
            </div>
            <div className="h-10 w-px bg-border" />
            <div>
              <div className="flex items-center gap-1 justify-center lg:justify-start">
                <Star className="h-4 w-4 fill-orange-500 text-orange-500" />
                <p className="text-xl lg:text-2xl font-bold text-foreground">4.9</p>
              </div>
              <p className="text-[10px] lg:text-xs text-muted-foreground uppercase tracking-widest font-bold">Google Rating</p>
            </div>
          </div>
        </motion.div>
