...
export default function Home() {
  return (
    <MainLayout>
      ...
      {/* 2. Promise Section */}
      <section id="promise" className="py-16 bg-zinc-50 dark:bg-zinc-900/50">
        <PromiseSection />
      </section>

      {/* 3. City Selection */}
      <section id="locations" className="py-16 bg-white dark:bg-zinc-950">
        <CitySelection />
      </section>

      {/* 4. Experience Section */}
      <section id="experience" className="py-16 bg-zinc-50 dark:bg-zinc-900/50">
        <ExperienceSection />
      </section>

      {/* 5. Location Section */}
      <section id="venue" className="py-16 bg-white dark:bg-zinc-950">
        <LocationSection />
      </section>

      {/* 6. Branches Section */}
      <section id="branches" className="py-16 bg-zinc-50 dark:bg-zinc-900/50">
        <BranchesSection />
      </section>

      {/* 7. FAQ Section */}
      <section id="accordion" className="py-16 bg-white dark:bg-zinc-950">
        <FAQSection />
      </section>

      {/* 8. Testimonials Section */}
      <section id="testimonials" className="py-16 bg-zinc-50 dark:bg-zinc-900/50">
        <Testimonials />
      </section>
    </MainLayout>
  );
