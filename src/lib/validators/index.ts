...
/* -------------------------------------------------------------------------- */
/*                         SIMPLE DB-FRIENDLY SCHEMAS                           */
/* These schemas map closely to the drizzle DB columns used by APIs so they
   avoid mismatches between frontend form keys and DB columns. */
/* -------------------------------------------------------------------------- */

export const dbPgSchema = z.object({
...
export const dbBedSchema = z.object({
  id: z.string().optional(),
...
export type DBPg = z.infer<typeof dbPgSchema>;
export type DBRoom = z.infer<typeof dbRoomSchema>;
export type DBBed = z.infer<typeof dbBedSchema>;
